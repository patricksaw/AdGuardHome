...
export const getStats = () => async (dispatch: any) => {
    ...
    try {
        ...
        const normalizedStats = {
            ...
            top_filtered_alert_domains: normalizeTopStats(stats.top_filtered_alert_domains || []),
            top_safebrowsing_alert_domains: normalizeTopStats(stats.top_safebrowsing_alert_domains || []),
            top_parental_alert_domains: normalizeTopStats(stats.top_parental_alert_domains || []),
