...
const stats = handleActions(
    {
        ...
        [actions.getStatsSuccess.toString()]: (state: any, { payload }: any) => {
            const {
                ...
                top_filtered_alert_domains: topFilteredAlertDomains,
                top_safebrowsing_alert_domains: topSafebrowsingAlertDomains,
                top_parental_alert_domains: topParentalAlertDomains,
                ...
                num_filtered_alert: numFilteredAlert,
                num_safebrowsing_alert: numSafebrowsingAlert,
                num_parental_alert: numParentalAlert,
            ...
            const newState = {
                ...
                replacedSafebrowsing,
                topBlockedDomains,
                topFilteredAlertDomains: topFilteredAlertDomains || [],
                topSafebrowsingAlertDomains: topSafebrowsingAlertDomains || [],
                topParentalAlertDomains: topParentalAlertDomains || [],
                topClients,
                ...
                numFilteredAlert: numFilteredAlert || 0,
                numSafebrowsingAlert: numSafebrowsingAlert || 0,
                numParentalAlert: numParentalAlert || 0,
                avgProcessingTime,
